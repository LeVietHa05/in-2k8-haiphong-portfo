...
export default function Header() {
    ...
    return (
        <div className="w-[1440] mx-auto relative h-230">
            ...
            <div className={`${instrument_Serif.className} flex flex-col justify-end items-end absolute z-2 top-39/100 right-20 h-91 w-254 bg-[#E0E1E1] text-right text-[56px] pr-4 pb-14 overflow-hidden`}>
