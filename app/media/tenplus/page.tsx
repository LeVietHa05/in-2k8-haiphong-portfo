    ...
    return (
        <div className="w-[1440] h-[1395px]  mx-auto shadow-md/20 relative bg-[#F9FAFC]">
            ...
            <div className="mx-auto " style={{ width: 813 }}>
                {/* title */}
                <div className="text-[96px] font-[Instrument_Serif] text-center leading-none">TEN PLUS 2025 Orientation Camp</div>

                <div>
                    <div className="relative z-1 flex flex-col items-center ">
                        <Image src={'/scroll-down.png'} className="" alt="" width={152} height={58}></Image>
                        <Image src={'/media-set-3-bg.png'} alt="" width={813} height={469}></Image>
                    </div>
